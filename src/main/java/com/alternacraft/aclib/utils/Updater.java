...
public class Updater {
    ...
    private void saveFile(String file) {
        ...
        if (this.announce) {
            MessageManager.log(ChatColor.YELLOW + "Finished updating. Do reload to load it.");
        }
    }
    ...
    private void downloadFile() {
        ...
        try {
            ...
            int count;
            if (this.announce) {
                MessageManager.log(ChatColor.AQUA + "About to download a new update: " + 
            ...
            while ((count = in.read(data, 0, Updater.BYTE_SIZE)) != -1) {
                ...
                if (this.announce && ((percent % 10) == 0)) {
                    MessageManager.log("Downloading update: " + percent + "% of " + fileLength + " bytes.");
                }
            }
        } catch (Exception ex) {
